...
const Index = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      toast({ title: "Signup failed", description: "Email or username already exists", variant: "destructive" });
    }
  };
        ...
        <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              {!user?.hasUploaded && (
                <div className="bg-columbia-blue-light border border-columbia-blue rounded-lg p-4 mb-4">
              ...
              <Button 
                ...
                className="bg-columbia-blue hover:bg-columbia-blue-dark text-white font-semibold px-8 py-3 text-lg"
              >
                Upload Materials
              </Button>
              ...
              {user?.hasUploaded && (
                <Button 
                  ...
                  variant="outline"
                  className="border-columbia-blue text-columbia-blue hover:bg-columbia-blue-light font-semibold px-8 py-3 text-lg"
                >
                  Browse Materials
                </Button>
              )}
    ...
    <div className="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Share and discover academic materials anonymously
        </p>
      </div>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      id="username"
                      type="text"
                      placeholder="e.g., StudyNinja2024"
